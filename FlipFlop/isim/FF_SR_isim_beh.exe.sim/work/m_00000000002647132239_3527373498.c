...
LAB6:    t5 = ((char*)((ng1)));
    t8 = xsi_vlog_unsigned_case_xcompare(t4, 2, t5, 2);
    if (t8 == 1)
        goto LAB7;

LAB8:    t2 = ((char*)((ng2)));
    t8 = xsi_vlog_unsigned_case_xcompare(t4, 2, t2, 2);
    if (t8 == 1)
        goto LAB9;
...
extern void work_m_00000000002647132239_3527373498_init()
{
	static char *pe[] = {(void *)Initial_25_0,(void *)Always_31_1};
	xsi_register_didat("work_m_00000000002647132239_3527373498", "isim/FF_SR_isim_beh.exe.sim/work/m_00000000002647132239_3527373498.didat");
